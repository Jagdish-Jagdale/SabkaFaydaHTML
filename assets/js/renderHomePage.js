            ...
            <div class="container mb-4 position-relative home-deferred-section">
                <div class="rounded-4 p-3 p-md-4" style="background: linear-gradient(180deg, #AEE7FF 0%, #CEEDFA 100%);">
                    <div class="d-flex justify-content-end mb-2">
                        <a href="${getViewAllLink(section.title)}" class="text-decoration-none fw-bold" style="color: #0066CC; font-size: 0.95rem; border-bottom: 2px solid #0066CC; padding-bottom: 2px;">View All</a>
                    </div>
                    <div class="row g-4">
            ...
            <div class="container mb-5 position-relative home-deferred-section">
                <div class="rounded-4 p-3 p-md-4" style="background: linear-gradient(180deg, #d4edda 0%, #a8e6cf 50%, #88d8b0 100%);">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="${getViewAllLink('On Sale')}" class="text-decoration-none fw-bold" style="color: #00A36C; font-size: 0.95rem; border-bottom: 2px solid #00A36C; padding-bottom: 2px;">View All</a>
                    </div>
                ...
                <div class="card border-0 shadow-sm rounded-3 overflow-hidden h-100 bg-white p-2 product-card">
                    <div class="rounded-2 overflow-hidden mb-2">
                        <div class="position-relative product-card-img-wrapper" style="cursor: pointer;" onclick="if(!event.target.closest('.btn')){ window.location.href='product-details.html'; }">
                            ...
                            <button class="btn border-0 position-absolute opacity-0 product-wishlist-btn card-icon-wishlist" title="Add to Wishlist" style="background-color: transparent !important; top: 8px; right: 8px; width: 32px; height: 32px; padding: 0; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease; font-size: 1.25rem; z-index: 5;">
                                <i class="far fa-heart"></i>
                            </button>
                            <button class="btn border-0 position-absolute opacity-0 product-share-btn card-icon-share" title="Share" style="background-color: transparent !important; top: 45px; right: 8px; width: 32px; height: 32px; padding: 0; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease; font-size: 1.1rem; z-index: 5;" onclick="event.stopPropagation();">
